...
namespace DesignPatternsLab13.Task3
{
    ...
    public static class Task3Demo
    {
        ...
        private static void InitializeTestData()
        {
            ...
            var admin = new Administrator("Али Кожабек", "aliloh@example.com", "ali2005");
            var teacher1 = new Teacher("Амир Байжан", "amir@example.com", "amir2005");
            var teacher2 = new Teacher("Эмир Молдахулов", "emir@example.com", "emir2006");
            var student1 = new Student("Евгений Александрович", "boss.universiteta@example.com", "Korol_777");
            var student2 = new Student("Никита Какойто", "nikita@example.com", "NikitaObychniy");
        ...
        private static void ShowLoginMenu()
        {
            ...
            Console.WriteLine("\n📋 Тестовые аккаунты:");
            Console.WriteLine("1. Администратор - aliloh@example.com / ali2005");
            Console.WriteLine("2. Преподаватель 1 - amir@example.com / amir2005");
            Console.WriteLine("3. Преподаватель 2 - emir@example.com / emir2006");
            Console.WriteLine("4. Студент 1 - boss.universiteta@example.com / Korol_777");
            Console.WriteLine("5. Студент 2 - nikita@example.com / NikitaObichniy");
            ...
            {
                case "1":
                    Login("aliloh@example.com", "ali2005");
                    break;
                case "2":
                    Login("amir@example.com", "amir2005");
                    break;
                case "3":
                    Login("emir@example.com", "emir2006");
                    break;
                case "4":
                    Login("boss.universiteta@example.com", "Korol_777");
                    break;
                case "5":
                    Login("nikita@example.com", "NikitaObichniy");
                    break;
                case "6":
                    RegisterNewUser();
                    break;
