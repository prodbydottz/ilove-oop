...
class Program
{
    static void Main(string[] args)
    {
        ...
        try
        {
            ...
            // Создаем файлы для вложенных папок
            ...
            // Демонстрация работы с отдельными пользователями
