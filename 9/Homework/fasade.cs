...
// Фасад для управления всей системой
...
class Program
{
    static void Main(string[] args)
    {
        ...
        // сздаем фасад для разных пользователей
